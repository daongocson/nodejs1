...
const getKsk= async (req, res)=>{ 
    const {idoa,today}= req.body;         
    const data = await getKskService(idoa,today);   
    return res.status(200).json(data);        
}
